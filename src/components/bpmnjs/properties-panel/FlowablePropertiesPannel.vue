    ...
    <el-collapse-item name="1">
      ...
      <el-form label-width="96px">
        <el-form-item>
          ...
          <el-input v-model="propertyName" @input="changeName" :disabled="!is(element, 'bpmn:UserTask')" />
        </el-form-item>
        <el-form-item class="mb-0">
          <template #label><label-tip message="flowable.properties.id" /></template>
          <el-input v-model="propertyId" @input="changeId" disabled />
        </el-form-item>
      </el-form>
    </el-collapse-item>
    <el-collapse-item v-if="is(element, 'bpmn:UserTask')" name="2">
      ...
      <el-form label-width="96px">
        <el-form-item>
          ...
          <el-select v-model="propertyRoleIds" @change="changeRoles" multiple class="w-full">
...
const props = defineProps({ modeler: null, queryRoles: { type: Function as PropType<() => Promise<any>>, required: true } });
