...
export const queryOperationLog = async (id: number): Promise<any> => (await axios.get(`/backend/core/operation-log/${id}`)).data;
...
export const deleteOperationLog = async (data: number[]): Promise<any> => (await axios.post('/backend/core/operation-log?_method=delete', data)).data;
